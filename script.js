...
$.getJSON(url, function (data) {
  ...
  if (typeof (Storage) !== "undefined") {
    document.getElementById("journalEntryResult").innerHTML = localStorage.getItem("journalEntry");
  } else {
    document.getElementById("journalEntryResult").innerHTML = "Click the button to determine your current mental state.";
  }
